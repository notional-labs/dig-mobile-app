...
import '../data/datasource/remote/validator_remote_datasource.dart' as _i18;
...
import '../data/repository/validator_repository_impl.dart' as _i20;
...
import '../domain/repository/validator_repository.dart' as _i19;
import '../domain/usecase/account/get_list_account_usecase.dart' as _i28;
import '../domain/usecase/account/get_list_balance_usecase.dart' as _i11;
import '../domain/usecase/account/get_selected_account_usecase.dart' as _i32;
import '../domain/usecase/account/select_account_usecase.dart' as _i38;
import '../domain/usecase/auth/change_pin_usecase.dart' as _i23;
import '../domain/usecase/auth/check_has_pin_usecase.dart' as _i24;
import '../domain/usecase/auth/check_mnemonic_valid_usecase.dart' as _i8;
import '../domain/usecase/auth/create_mnemonic_usecase.dart' as _i25;
import '../domain/usecase/auth/create_pin_usecase.dart' as _i26;
import '../domain/usecase/auth/delete_pin_usecase.dart' as _i27;
import '../domain/usecase/auth/import_account_usecase.dart' as _i35;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i18.ValidatorRemmoteDatasource>(
      () => _i18.ValidatorRemmoteDatasourceImplement());
  gh.factory<_i19.ValidatorRepository>(() => _i20.ValidatorRepositoryImplement(
      get<_i18.ValidatorRemmoteDatasource>()));
  gh.factory<_i21.AuthRepository>(() => _i22.AuthRepositoryImplement(
      get<_i13.PinLocalDatasource>(), get<_i3.AccountLocalDatasource>()));
  gh.factory<_i23.ChangePinUseCase>(
      () => _i23.ChangePinUseCase(get<_i21.AuthRepository>()));
  gh.factory<_i24.CheckHasPinUseCase>(
      () => _i24.CheckHasPinUseCase(get<_i21.AuthRepository>()));
  gh.factory<_i25.CreateMnemonicUseCase>(
      () => _i25.CreateMnemonicUseCase(get<_i21.AuthRepository>()));
  gh.factory<_i26.CreatePinUseCase>(
      () => _i26.CreatePinUseCase(get<_i21.AuthRepository>()));
  ...
  gh.factory<_i34.GetValidatorUseCase>(() => _i34.GetValidatorUseCase(
      get<_i19.ValidatorRepository>(), get<_i12.ENV>()));
  gh.factory<_i35.ImportAccountUseCase>(() =>
      _i35.ImportAccountUseCase(get<_i21.AuthRepository>(), get<_i12.ENV>()));
  gh.factory<_i36.MatchPinUseCase>(
      () => _i36.MatchPinUseCase(get<_i21.AuthRepository>()));
  gh.factory<_i37.RemoveAccountUseCase>(() =>
      _i37.RemoveAccountUseCase(get<_i21.AuthRepository>(), get<_i12.ENV>()));
  gh.factory<_i38.SelectAccountUseCase>(
      () => _i38.SelectAccountUseCase(get<_i21.AuthRepository>()));
  return get;
}
